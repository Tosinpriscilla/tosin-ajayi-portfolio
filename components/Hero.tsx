      ...
      <div className="container mx-auto px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            >
              I&apos;m a UK-based Product Designer with 5+ years of experience
              designing accessible, user-centered digital products across
              Fintech, Healthcare, and E-commerce. I transform complex problems
              into elegant solutions through research-driven design.
            </motion.p>
