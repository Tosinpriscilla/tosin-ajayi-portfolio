...
export function CaseStudy({ title, description, image, customThumbnail, tags, outcome, index, comingSoon }: CaseStudyProps) {
  return (
    <motion.div
      ...
      className="h-full"
    >
      <Card className={`overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-shadow duration-300 group h-full flex flex-col ${comingSoon ? '' : 'cursor-pointer'}`}>
